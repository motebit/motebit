...
pnpm monorepo, Turborepo, TypeScript. Node ≥ 20, pnpm 9.15. 35 packages on a 7-layer DAG enforced by `pnpm check-deps`. 5 surfaces + 3 supporting apps, 8 services, 12 open protocol specs.

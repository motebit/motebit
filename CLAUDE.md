...
- [`packages/verifier-hardware/CLAUDE.md`](packages/verifier-hardware/CLAUDE.md) — BSL companion CLI that bundles the four platform leaves into `motebit-verify-hw`

...
pnpm monorepo, Turborepo, TypeScript. Node ≥ 20, pnpm 9.15. 51 packages on a 7-layer DAG enforced by `pnpm check-deps`. 5 surfaces + 6 supporting apps, 8 services, 26 open protocol specs.

...
- [`docs/doctrine/design-ratios.md`](docs/doctrine/design-ratios.md) — aspect-ratio decisions for body-adjacent display surfaces in the droplet/material family default to φ (golden ratio) unless a stronger governing law applies; canonical `GOLDEN_RATIO` exported from `@motebit/render-engine`

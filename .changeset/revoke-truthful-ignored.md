...
- #788 stays open: an operator reinstate can reverse an identity's own `/revoke` or a migration departure, because a departure can be signed by a first-come squatter (the #798 review showed a departure block locked out keyless legacy ids).

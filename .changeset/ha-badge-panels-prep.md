...
3. Mirror surfaces: apps/web/src/ui/gated-panels.ts (agents tab), apps/mobile/src/components/AgentsPanel.tsx. Web shows "—" pending the play-integrity removal at 2.0.0 (per `play_integrity_real_fixture_structurally_blocked`).

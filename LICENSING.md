...
| `packages/verify/`                | `@motebit/verify`                | `motebit-verify` CLI (bundles the four platform leaves with motebit-canonical defaults) |

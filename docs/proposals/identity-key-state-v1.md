...
- **L6 — §8's second clause, enumerated.** For each backfill source (registry, chain, agreeing devices) and for the ambiguous identity the backfill leaves unfilled, guardian recovery succeeds after v42 exactly when it did before.

...
| 6            | `/.well-known/motebit-retention.json` signed manifest + browser-side re-verifier (6a, shipped). `check-retention-coverage` lands hard at drift-defense #67 (6b, shipped). `docs/drift-defenses.md` updated to #67.                                                                                                                                                                                                                                                                                                                         |
...
- `docs/drift-defenses.md` — `#39 @deprecated four-field contract` (decision 6a migration); `#67 check-retention-coverage` lands with phase 6b (the doctrine reserved #52 in phase 1; the slot was occupied during post-doctrine renumbering, so the gate shipped at the next free invariant number).

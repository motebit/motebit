...
| -------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Identity             | Ed25519 keypair as the floor (`packages/protocol`, `packages/crypto`); hardware-rooted attestation (`packages/crypto-{appattest,android-keystore,tpm,webauthn}`) is additive, raising the trust score, not replacing the software floor. User-owned, not account-bound.    |

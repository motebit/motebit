...
| Aspect ratio          | golden-ratio (φ ≈ 1.618:1) per [`design-ratios.md`](design-ratios.md)               | Held-tablet feel, not wall-monitor. The slab is the first member of the droplet family under that rule; downstream surfaces (artifact cards, constellation clusters, typography scale) follow.                                                                                            |

...
main().catch((err: unknown) => {
  // A damaged config is the one failure where the stack trace is the least
  // useful thing we could show: the user needs to know their file was left
  // alone and what to do next, not where we threw.

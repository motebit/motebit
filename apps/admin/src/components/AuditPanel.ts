...
function decisionLabel(entry: ToolAuditEntry): { text: string; className: string } {
  if (entry.decision.requiresApproval) return { text: "approval", className: "audit-decision approval" };
...
export function AuditPanel({ entries }: { entries: ToolAuditEntry[] }): React.ReactElement {
  ...
  return React.createElement("div", { className: "panel" },
    ...
    ...recent.map((e) => {
      ...
      return React.createElement("div", { key: e.callId, className: "event-entry" },

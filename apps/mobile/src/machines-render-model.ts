/**
 * Settings → Identity → Machines, as data — the phone's render model of the
 * shared machine-roster section (`docs/proposals/machine-roster-surfaces-v1.md`
 * S5). `components/settings/MachinesSection.tsx` only lays this out, so every
 * rule a reviewer cares about is here and unit-tested in node:
 *

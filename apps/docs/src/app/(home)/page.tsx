          ...
          <Reveal>
            <div className="mx-auto max-w-2xl">
              <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/50 p-6 font-mono text-sm shadow-sm overflow-x-auto">
                <div className="flex items-center gap-2 mb-4 text-fd-muted-foreground border-b border-zinc-200 dark:border-zinc-800 pb-4">
                ...
                <div className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
                  ...
                  <span className="text-fd-foreground">npm create motebit@latest my-agent</span>
                  <br />
                  <span className="text-fd-muted-foreground">Generating Ed25519 keypair...</span>
                  <br />
                  <span className="text-fd-muted-foreground">Signing identity file...</span>
                  <br />
        ...
        <section className="py-28 md:py-40 px-6">
          <Reveal>
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-6 text-lg md:text-xl text-fd-muted-foreground leading-relaxed max-w-lg mx-auto">
        ...
        <section className="py-36 md:py-48 px-6">
          <Reveal>
            <div className="mx-auto max-w-xl text-center">
              <p className="text-lg md:text-2xl text-fd-muted-foreground leading-relaxed italic">
              ...
              <p className="mt-8 text-fd-muted-foreground text-xs tracking-[0.2em] uppercase">

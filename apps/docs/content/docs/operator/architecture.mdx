...
│   ├── inspector/             [supporting]  React + Vite single-agent inspector. 15-tab interior view.
...
| `inspector` | Supporting | Internal | React + Vite single-agent inspector. 15-tab real-time view of one motebit's interior via the relay.            |

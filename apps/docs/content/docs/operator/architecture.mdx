...
The shape is **48 packages · 7 architectural layers · 5 surfaces + 5 supporting apps · 8 services · 22 open specs**. Layer membership is enforced by `pnpm check-deps` in CI — violations break the build.

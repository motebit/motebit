...
| `apps/admin` | React + Vite dashboard. 9-tab real-time monitoring — state vector, memory graph, behavior cues, event log, tool audit, goals, plans, conversations, devices. |

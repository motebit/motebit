...
The shape is **46 packages · 7 architectural layers · 5 surfaces + 3 supporting apps · 8 services · 19 open specs**. Layer membership is enforced by `pnpm check-deps` in CI — violations break the build.

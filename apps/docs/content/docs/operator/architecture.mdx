...
The shape is **36 packages · 7 architectural layers · 5 surfaces + 3 supporting apps · 8 services · 12 open specs**. Layer membership is enforced by `pnpm check-deps` in CI — violations break the build.
...
│
├── spec/                      # 13 open specifications, each motebit/<name>@1.0

...
| `operator`  | Supporting | Internal | React + Vite relay-operator console. 6 tabs: withdrawals, federation peers, transparency, disputes, fees, credential anchoring. Master-token gated; fleet-shaped. |

...
│   ├── verifier-hardware/     [L6]          BSL companion CLI `motebit-verify-hw` that bundles the four platform leaves (App Attest, TPM, Play Integrity, WebAuthn) for end-to-end hardware-attestation verification.
│   │

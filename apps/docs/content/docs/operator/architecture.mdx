...
The shape is **52 packages · 7 architectural layers · 5 surfaces + 6 supporting apps · 9 services · 31 open specs**. Layer membership is enforced by `pnpm check-deps` in CI — violations break the build.

...
The shape is **51 packages · 7 architectural layers · 5 surfaces + 6 supporting apps · 8 services · 26 open specs**. Layer membership is enforced by `pnpm check-deps` in CI — violations break the build.

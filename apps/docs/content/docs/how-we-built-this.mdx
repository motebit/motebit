...
*A snapshot of the first 47 days — February 15 to April 2, 2026. The numbers on this page are frozen at that date. The project continued after; current counts and the published-package surface live in [Public surface](/docs/concepts/public-surface) and the operator [Architecture](/docs/operator/architecture).*
...
| **Tests** | 4,600+ |
| **Packages** | 45 |
| **Application surfaces** | 8 — desktop, CLI, mobile, web, spatial, inspector, docs, identity |
...
30 seconds to a signed agent identity. The [specifications](https://github.com/motebit/motebit/tree/main/spec) are Apache-2.0 licensed. The [source](https://github.com/motebit/motebit) is available.

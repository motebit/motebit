...
description: 200K lines of TypeScript in 47 days. One human architect, one AI pair programmer. 1,204 commits.
---
...
One human. One AI. 1,204 commits. 1,154 co-authored with [Claude](https://claude.ai).
...
A new routing concern — regulatory compliance across jurisdictions — expressed in 7 lines of code. Zero new algorithms. Swap the semiring, change what "best path" means. The entire routing layer collapsed from procedural wiring into algebra.
...
We are honest about this because the gap between built and proven is where most projects die.
...
47 calendar days. 40 days with commits. A 6-day gap where the economic thesis crystallized. A 46-hour sprint where the semiring snapped into focus at hour 40. 1,204 commits. 1,154 co-authored with Claude.

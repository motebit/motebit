...
- **At rest.** The private key lives in the OS keyring on desktop and mobile. On the CLI it is encrypted with your passphrase using PBKDF2 (600,000 iterations, SHA-256) and AES-256-GCM — never written in plaintext.

...
| `motebit runs [list\|ack <run_id>]` | Goal-run ledger: runs holding their goal (paused on you, or interrupted with side effects) and recent runs; `ack` releases a reviewed interrupted run |

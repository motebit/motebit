...
`@motebit/crypto` verifies any Motebit artifact — identity files, execution receipts, verifiable credentials, and presentations. One function, zero monorepo dependencies, MIT licensed.

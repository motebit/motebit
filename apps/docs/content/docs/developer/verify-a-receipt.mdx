...
- **Integrity-only** (signature valid, identity *not* bound — the honest weaker rung): [`example-receipt.json`](https://raw.githubusercontent.com/motebit/motebit/main/examples/python-receipt-verifier/fixtures/example-receipt.json)

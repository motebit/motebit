...
Everything is local. Your memories, your identity, your conversation history — all stored on your machine in a local SQLite database protected by filesystem permissions; your private key is the part that is encrypted (PBKDF2 + AES-256-GCM, or the OS keyring).

...
Desktop releases are coming soon. In the meantime, you can create a signed agent identity with `npm create motebit` and use the CLI (`npm install -g motebit`) as a full operator console.

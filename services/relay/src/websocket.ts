...
export interface WebSocketDeps {
   ...
   * `connections`, with the peer as it was. The roster's liveness record
   * is written from here — a relay's one durable observation of a
   * machine is when it last saw it.
   */

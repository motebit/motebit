 ...
 *
 * @deprecated Use `@motebit/crypto-android-keystore` for canonical
 *   Android hardware attestation. This package is scheduled for
 *   removal at `@motebit/crypto-play-integrity@2.0.0`.
 */
 ...
 *
 * @deprecated Use `androidKeystoreVerifier` from
 *   `@motebit/crypto-android-keystore` for canonical sovereign-verifiable
 *   Android hardware attestation. The pinned-Google-JWKS model this
 *   factory was scaffolded against does not match Google's Play Integrity
 *   API design — Google publishes no public JWKS for Play Integrity
 *   verdicts. Removed at `@motebit/crypto-play-integrity@2.0.0`.
 */

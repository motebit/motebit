...
Surface-agnostic controllers for the Sovereign panel (credentials, execution ledger, budget, succession). State derivation, relay I/O, and action handlers live here. Rendering — DOM for desktop/web, React Native for mobile — stays at the surface.

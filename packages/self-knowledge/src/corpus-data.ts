...
export const CORPUS_INDEX: CorpusIndex = {
  chunks: [
    ...
    {
      id: "README.md#run-your-own-relay-sovereign-local-one-command",
      source: "README.md",
      title: "Run your own relay — sovereign, local, one command",
      content: "motebit relay up",
      termFrequencies: {
        motebit: 1,
        relay: 1,
      },
    ...
    {
      id: "README.md#listening-on-http-localhost-3000",
      source: "README.md",
    ...
    {
      id: "README.md#run-a-signed-relay-container",
      source: "README.md",
      title: "Run a signed relay container",
      content:
    ...
    {
      id: "README.md#plus-motebit-sync-url-and-motebit-api-token-in-env",
      source: "README.md",
      title: "plus MOTEBIT_SYNC_URL and MOTEBIT_API_TOKEN, in .env",
      content:
    ...
    {
      id: "README.md#suite-motebit-jcs-ed25519-hex-v1",
      source: "README.md",
      title: "suite            motebit-jcs-ed25519-hex-v1",
      content:
  ...
  averageLength: 94.33333333333333,
  totalDocuments: 84,
  sourceHash: "11d1db7aacece5efdebe559df4431754edbdb2ff9ebb24220c630f4d3f4478e5",
  generatedAt: "sha256:11d1db7aacece5ef",
};

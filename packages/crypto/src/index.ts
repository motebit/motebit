/**
 * @motebit/crypto — Product security: encryption, key derivation, deletion.
 *
 * Protocol signing primitives (Ed25519, canonical JSON, receipts, delegations,
 * credentials, successions) now live in MIT @motebit/verify. This package
 ...
 *
 * Uses @noble/hashes for SHA-512 and Web Crypto API for AES-256-GCM/PBKDF2.
 */

// ── Re-export protocol signing primitives from @motebit/verify ──────
// Backward compat: consumers import from @motebit/crypto unchanged.
...
// ── Re-export credential signing from @motebit/verify ───────────────

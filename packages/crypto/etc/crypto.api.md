...
// @public (undocumented)
export function issueGradientCredential(
  snapshot: {
    gradient: number;
    knowledge_density: number;
    knowledge_quality: number;
...
// @public (undocumented)
export function issueTrustCredential(
  trustRecord: {
    trust_level: string;
...
// @public
export function signCollaborativeReceipt(
...
// @public
export function signExecutionReceipt<T extends Omit<SignableReceipt, "signature">>(
  receipt: T,
  privateKey: Uint8Array,
  publicKey?: Uint8Array,
): Promise<
...
// @public
export function signGuardianRecoverySuccession(
...
// @public
export function signGuardianRevocation(
...
// @public
export function signKeySuccession(
...
// @public
export function signSovereignPaymentReceipt(
...
// @public (undocumented)
export function signVerifiableCredential<T = Record<string, unknown>>(
...
// @public (undocumented)
export function signVerifiablePresentation(
...
// @public
export function verifyCollaborativeReceipt(
...
// @public
export function verifyCredentialAnchor(
...
// @public
export function verifyGuardianRevocation(
  revocation: {
    identity_signature: string;
    guardian_signature: string;
    timestamp: number;
...
// @public
export function verifyKeySuccession(
...
// @public
export function verifyRevocationAnchor(
...
// @public (undocumented)
export function verifyVerifiableCredential<T = Record<string, unknown>>(

...
- bd51d56: Add a real captured-from-browser WebAuthn `packed` ceremony fixture and an end-to-end test that runs `verifyWebAuthnAttestation` against it under the production-pinned FIDO root accept-set.

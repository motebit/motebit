...
- d3e8163: Replace placeholder vendor EK root PEMs with real, vendor-published bytes for all four pinned TPM 2.0 vendors. Adds a fifth root: STMicroelectronics ships parallel RSA + ECC PKIs for the ST33 / STSAFE-TPM family, and both are now pinned.

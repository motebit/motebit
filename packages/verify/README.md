...
Implements the verification algorithm from the [motebit/identity@1.0](../../spec/identity-v1.md) specification. Zero monorepo dependencies — only [`@noble/ed25519`](https://github.com/paulmillr/noble-ed25519) for cryptography.
...
See the [motebit/identity@1.0 specification](../../spec/identity-v1.md) for details.

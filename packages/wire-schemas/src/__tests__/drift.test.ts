...
const CASES: SchemaCase[] = [
  ...
  {
    name: "standing-delegation-v1",
    filename: "standing-delegation-v1.json",
    expectedId: STANDING_DELEGATION_SCHEMA_ID,
    build: buildStandingDelegationJsonSchema,
  },
  {
    name: "delegation-revocation-v1",

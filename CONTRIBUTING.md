...
packages/    53 packages on a 7-layer DAG enforced by `pnpm check-deps`
services/    10 backend services (1 relay + 3 molecules + 5 atoms + 1 glue)
spec/        33 open specifications, each `motebit/<name>@1.0`
```
